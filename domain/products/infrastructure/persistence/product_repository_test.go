...
func TestCreateProduct(t *testing.T) {
	...
	product := &model.Product{ProductName: "Test", ProductAmount: 10, ProductPrice: 5.5, ProductUserCreated: 1}
...
func TestCreateProductError(t *testing.T) {
	...
	repo := NewProductRepository(pool)
	product := &model.Product{ProductName: "Test", ProductUserCreated: 1}
...
func TestUpdateProduct(t *testing.T) {
	...
	repo := NewProductRepository(pool)
	product := &model.Product{ProductName: "Updated", ProductAmount: 20, ProductUserModify: 2}
