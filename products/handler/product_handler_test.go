...
func TestProductHandler_CreateProduct(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		...
		product := models.Product{ProductName: "Test", ProductAmount: 1, ProductUserCreated: 1}
		created := &models.Product{ProductID: 1, ProductName: "Test", ProductAmount: 1, ProductUserCreated: 1}
...
func TestProductHandler_GetProduct(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		...
		product := &models.Product{ProductID: 1, ProductName: "Test"}
	...
	t.Run("not found", func(t *testing.T) {
		...
		mockSvc.On("GetProduct", mock.Anything, int64(99)).Return(nil, customErrors.ErrNotFound)
...
func TestProductHandler_GetProducts(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		...
		products := []*models.Product{{ProductID: 1}, {ProductID: 2}}
...
func TestProductHandler_UpdateProduct(t *testing.T) {
	...
	t.Run("invalid id", func(t *testing.T) {
		...
		c, rec := newProductRequest(t, http.MethodPut, "/products/abc", models.Product{})
		c.SetParamNames(constants.ID)
		c.SetParamValues("abc")
...
func TestProductHandler_DeleteProduct(t *testing.T) {
	...
	t.Run("not found", func(t *testing.T) {
		...
		mockSvc.On("DeleteProduct", mock.Anything, int64(99)).Return(customErrors.ErrNotFound)
